...
All content is publicly available under the Creative Commons Attribution License: https://creativecommons.org/licenses/by/4.0/
  ...
  ### Antes de empezar, por favor asegúrese que tiene 
...
## Representación simplificada de datos espaciales
...
psize  <- 1 + precip/500
plot(estaciones, cex=psize, pch=20, col="red", 
     main="Precipitación (mm/año)")
